...
const messages = {
  ...
  q1iNotifyingPartyOrRepresentative:
    "Select notifier or representative of notifier",
  q1iiNotifyingPartyName: "Enter the name of the notifier",
  ...
  q1iiiNotifyingPartyName: "Enter the name of the notifier",
  q1iiiNotifyingPartyIndividual:
    "Enter the name of the authorised individual from notifying party",
  q1iiiNotifyingPartyEmail: "Enter the email of the notifier",
  q1iiiNotifyingPartyPhone: "Enter the telephone number of the notifier",
  ...
  q1iiiAuthorisedIndividual:
    "Enter the full name of the representatives’ authorised individual",
  ...
  q1iiiRelationship: "Enter the representatives’ relationship to the notifier",
  q1iiiAuthorised:
    "Select if this individual is authorised to accept correspondence",
  q1ivAdditionalAcquirer:
    "Select if there is more than one acquirer involved in this acquisition",
  ...
  q2iCaseReference: "Enter details of the previous notification",
  q30Reason:
    "Enter information on why the UK government was not notified about this acquisition",
  ...
  q5iNameIndividualQualifyingEntity:
    "Enter full name of the authorised individual",
  q5iEmail: "Enter the email address of the authorised individual",
  q5iTelephone: "Enter the telephone number of the authorised individual",
...
/* Perform validation on question 3 - 0 */
exports.validateQuestion3Page0 = function (data) {
  var returnList = { isValid: true };

  if (validatorHelpers.isBlankCheck(data["q30Reason"])) {
    returnList["q30Reason"] = messages["q30Reason"];
    returnList.isValid = false;
  }
...
/* Perform validation on question 7 - 2 */
exports.validateQuestion7Page2 = function (data) {
  var returnList = { isValid: true };

  if (data["q7iIncorporatedOutsideUk"] === "No") {
    if (validatorHelpers.isBlankCheck(data["q7iCompaniesHouseReference"])) {
      returnList["q7iCompaniesHouseReference"] =
        messages["q7iCompaniesHouseReference"];
      returnList.isValid = false;
    }

    if (validatorHelpers.isBlankCheck(data["q7iSICReference"])) {
      returnList["q7iSICReference"] = messages["q7iSICReference"];
      returnList.isValid = false;
    }
  } else {
    if (
      validatorHelpers.isBlankCheck(
        data["q7iRegistrationDetailsCountryOfCorporation"]
      )
    ) {
      returnList["q7iRegistrationDetailsCountryOfCorporation"] =
        messages["q7iRegistrationDetailsCountryOfCorporation"];
      returnList.isValid = false;
    }
  }
...
exports.validateQuestionStatusQ3 = function (data) {
  ...
  qResults.push(checkState(this.validateQuestion3Page0(data)));
...
exports.validateQuestionStatusQ7 = function (data) {
  ...
  if (data["q7iEntityOrIndividual"] === "entity") {
    qResults.push(checkState(this.validateQuestion7Page2(data)));
  }
