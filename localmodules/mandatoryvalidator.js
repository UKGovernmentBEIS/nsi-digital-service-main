...
const messages = {
  q1iAcquirerOrRepresentative: "Select acquirer or representative of acquirer",
  q1iiAcquirerFullname: "Enter the name of the acquirer",
  q1iiAcquirerBusinessaddress: "Enter the business address of the acquirer",
  q1iiAcquirerIndividual: "Enter your full name",
  q1iiAcquirerPosition: "Enter your position",
  q1iiAcquirerEmail: "Enter your email",
  q1iiAcquirerTelephone: "Enter your telephone number",
  q1iiAuthorised: "Select if you are authorised to accept correspondence",
  q1iiiAcquiringPartyName: "Enter the name of the acquirer",
  q1iiiAcquiringPartyIndividual:
    "Enter the full name of the person within acquirer we can contact if needed",
  q1iiiAcquiringPartyEmail:
    "Enter the email of the person within acquirer we can contact if needed",
  q1iiiAcquiringPartyTelephone:
    "Enter the telephone number of the person within acquirer we can contact if needed",
  ...
  q1iiiRepresentativeEmail: "Enter the email of the authorised individual",
  q1iiiRepresentativePhone:
    "Enter the telephone number of the authorised individual",
  q1iiiRelationship: "Enter the representative’s relationship to the acquirer",
  q1iiiAuthorised: "Select if you are authorised to accept correspondence",
  ...
  q1ivaMultinotifierEmail: "Enter the email of the acquirer",
  q2iiSubmitTwelve:
    "Select if a notification has been submitted to an overseas investment screening regime in the last 12 months",
  q2iiAdditionalInfo: "Enter details of the notification",
  q2iCaseReference: "Enter details of the notification",
  ...
  question3iiiDetailsPreventPassageDetails:
    "There is a problem Enter additional information",
  question3iiiPercentResolutionTriggerDetails:
    "A maximum of 5000 characters is allowed",
  question3ivAcquisitionDetails:
    "Enter the percentage of shareholding or voting rights being acquired",
  ...
  q5iWebsite: "Enter a valid website address",
  q5iActivitiesDescription:
    "Enter a description of activities, products and services",
  ...
  q7iCompaniesHouseReference: "Enter a companies house reference",
  q7iSICReference: "Enter SIC reference",
  q7iRegistrationDetailsCountryOfCorporation: "Enter registration details",
...
exports.validateQuestion1Page1 = function (data) {
  ...
  if (validatorHelpers.isBlankCheck(data["q1iAcquirerOrRepresentative"])) {
    returnList["q1iAcquirerOrRepresentative"] =
      messages["q1iAcquirerOrRepresentative"];
...
exports.validateQuestion1Page2 = function (data, taskListCheck) {
  ...
  if (validatorHelpers.isBlankCheck(data["q1iiAcquirerFullname"])) {
    returnList["q1iiAcquirerFullname"] = messages["q1iiAcquirerFullname"];
    returnList.isValid = false;
  }

  if (validatorHelpers.isBlankCheck(data["q1iiAcquirerBusinessaddress"])) {
    returnList["q1iiAcquirerBusinessaddress"] =
      messages["q1iiAcquirerBusinessaddress"];
    returnList.isValid = false;
  }

  if (validatorHelpers.isBlankCheck(data["q1iiAcquirerIndividual"])) {
    returnList["q1iiAcquirerIndividual"] = messages["q1iiAcquirerIndividual"];
    returnList.isValid = false;
  }

  if (validatorHelpers.isBlankCheck(data["q1iiAcquirerPosition"])) {
    returnList["q1iiAcquirerPosition"] = messages["q1iiAcquirerPosition"];
    returnList.isValid = false;
  }

  if (validatorHelpers.isBlankCheck(data["q1iiAcquirerEmail"])) {
    returnList["q1iiAcquirerEmail"] = messages["q1iiAcquirerEmail"];
    returnList.isValid = false;
  }

  if (validatorHelpers.isBlankCheck(data["q1iiAcquirerTelephone"])) {
    returnList["q1iiAcquirerTelephone"] = messages["q1iiAcquirerTelephone"];
    returnList.isValid = false;
  }
...
exports.validateQuestion1Page3 = function (data) {
  ...
  if (validatorHelpers.isBlankCheck(data["q1iiiAcquiringPartyName"])) {
    returnList["q1iiiAcquiringPartyName"] = messages["q1iiiAcquiringPartyName"];
    returnList.isValid = false;
  }

  if (validatorHelpers.isBlankCheck(data["q1iiiAcquiringPartyIndividual"])) {
    returnList["q1iiiAcquiringPartyIndividual"] =
      messages["q1iiiAcquiringPartyIndividual"];
    returnList.isValid = false;
  }

  if (validatorHelpers.isBlankCheck(data["q1iiiAcquiringPartyEmail"])) {
    returnList["q1iiiAcquiringPartyEmail"] =
      messages["q1iiiAcquiringPartyEmail"];
    returnList.isValid = false;
  }

  if (validatorHelpers.isBlankCheck(data["q1iiiAcquiringPartyTelephone"])) {
    returnList["q1iiiAcquiringPartyTelephone"] =
      messages["q1iiiAcquiringPartyTelephone"];
    returnList.isValid = false;
  }
...
/* Perform validation on question 2 - 3 */
...
/* Perform validation on question 2 - 3 */
exports.validateQuestion2Page3 = function (data) {
  var returnList = { isValid: true };

  if (validatorHelpers.isBlankCheck(data["q2iiSubmitTwelve"])) {
    returnList["q2iiSubmitTwelve"] = messages["q2iiSubmitTwelve"];
    returnList.isValid = false;
  }

  if (validatorHelpers.isRadioValueYes(data["q2iiSubmitTwelve"])) {
    if (validatorHelpers.isBlankCheck(data["q2iiAdditionalInfo"])) {
      returnList["q2iiAdditionalInfo"] = messages["q2iiAdditionalInfo"];
      returnList.isValid = false;
    }
  }
...
exports.validateQuestion3Page3 = function (data) {
  ...
  if (!oneIsValid) {
    returnList["question3iiiDetailsPercentageShare"] =
      messages["question3iiiTriggerEvents"];
    returnList.isValid = false;
  }
...
exports.validateQuestion3Page4 = function (data) {
  ...
  if (validatorHelpers.isBlankCheck(data["question3ivAcquisitionDetails"])) {
    returnList["question3ivAcquisitionDetails"] =
      messages["question3ivAcquisitionDetails"];
    returnList.isValid = false;
  }
...
exports.validateQuestion4Page3a = function (data) {
  ...
  if (
    !validatorHelpers.isDateValid(
      data["q4icKeyDate-day"],
      data["q4icKeyDate-month"],
      data["q4icKeyDate-year"],
      true
    )
  ) {
...
/* Perform validation on question 6 - 1 */
exports.validateQuestion6Page1 = function (data) {
  var returnList = { isValid: true };

  if (validatorHelpers.isBlankCheck(data["q6iPreAcquisitionChartFileName"])) {
    returnList["q6iPreAcquisitionChartFileName"] =
      messages["q6iPreAcquisitionChartFileName"];
    returnList.isValid = false;
  }
...
/* Perform validation on question 6 - 2 */
exports.validateQuestion6Page2 = function (data) {
  var returnList = { isValid: true };

  if (validatorHelpers.isBlankCheck(data["q6iiPostAcquisitionChartFileName"])) {
    returnList["q6iiPostAcquisitionChartFileName"] =
      messages["q6iiPostAcquisitionChartFileName"];
    returnList.isValid = false;
  }
...
/* Perform validation on question 6 - 4 */
exports.validateQuestion6Page4 = function (data) {
  var returnList = { isValid: true };

  if (validatorHelpers.isBlankCheck(data["addNonUKGovernment"])) {
    returnList["addNonUKGovernment"] = messages["q6iiiNonUKGovt"];
    returnList.isValid = false;
  }
...
/* Perform validation on question 8 - 1 */
exports.validateQuestion8Page1 = function (data) {
  var returnList = { isValid: true };

  if (validatorHelpers.isBlankCheck(data["q8iControllingOwnershipFileName"])) {
    returnList["q8iControllingOwnershipFileName"] =
      messages["q8iControllingOwnershipFileName"];
    returnList.isValid = false;
  }
...
exports.validateQuestionStatusQ1 = function (data) {
  ...
  if (data["q1iAcquirerOrRepresentative "] === "acquirer") {
    qResults.push(checkState(this.validateQuestion1Page2(data)));
  } else if (data["q1iAcquirerOrRepresentative "] === "representative") {
...
exports.validateQuestionStatusQ2 = function (data) {
  ...
  qResults.push(checkState(this.validateQuestion2Page3(data)));
...
exports.validateQuestionStatusQ5 = function (data) {
  ...
  if (validatorHelpers.isRadioValueYes(data["q5iiIsAuthorised"])) {
    if (!validatorHelpers.isBlankCheck(data["q5iiaClassificationListItems"])) {
      qResults.push("Completed");
    }
  }
  ...
  if (validatorHelpers.isRadioValueYes(data["q5viIsFundedResearch"])) {
    if (!validatorHelpers.isBlankCheck(data["q5viaFundedResearchListItems"])) {
      qResults.push("Completed");
    }
  }
...
exports.validateQuestionStatusQ6 = function (data) {
  ...
  //qResults.push(checkState(this.validateQuestion6Page1(data)));
  //qResults.push(checkState(this.validateQuestion6Page2(data)));
  if (
...
exports.validateQuestionStatusQ8 = function (data) {
  ...
  //qResults.push(checkState(this.validateQuestion8Page1(data)));
  if (
