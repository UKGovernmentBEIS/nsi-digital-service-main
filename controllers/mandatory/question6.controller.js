...
exports.question6Page1 = async function (req, res, next) {
  ...
  if (
    ...
    res.render("mandatory/question6-1", { data: req.session.data });
  } else {
    res.render("mandatory/question6-1", {
...
exports.question6Page1PostConfirm = async function (req, res, next) {
  ...
  //webHelper.sessionRedirect(next, res, req, "/mandatory/check-your-answers/check-your-answers");
  webHelper.sessionRedirect(next, res, req, "/mandatory/question6/question6-2");
};
...
exports.question6Page1Post = async function (req, res, next) {
  ...
  var uploadValidation =
    fileUploadValidator.validateFileUploadQuestion6Page1(req);
  if (uploadValidation.isValid === false) {
    ...
    webHelper.sessionRedirect(
      ...
      res,
      req,
      "/mandatory/question6/question6-1"
    );
    return;
  }

  console.log("Q6 controller 1:" + req.session.data["notificationReference"]);
  ...
  if (
    ...
    console.log("Q6 controller: Session is NULL");
  }
  ...
  if (dataUpload == "success") {
    ...
    webHelper.sessionRedirect(
      ...
      res,
      req,
      "/mandatory/question6/question6-2"
    );
  } else {
    return next({
...
exports.question6Page2 = async function (req, res, next) {
  if (
    ...
    res.render("mandatory/question6-2", { data: req.session.data });
  } else {
    res.render("mandatory/question6-2", {
      data: req.session.data,
      uploadvalidation: req.session.uploadValidation,
    });
  }
...
exports.question6Page2Post = async function (req, res, next) {
  ...
  // Perform the file upload validation
  var uploadValidation =
    fileUploadValidator.validateFileUploadQuestion6Page2(req);
  if (uploadValidation.isValid === false) {
    req.session.uploadValidation = uploadValidation;
    webHelper.sessionRedirect(
      next,
  ...
  if (dataUpload == "success") {
    ...
    webHelper.sessionRedirect(
      ...
      res,
      req,
      "/mandatory/question6/question6-3"
    );
  } else {
    return next({
      message: "File could not be saved to the database",
...
exports.question6Page2PostConfirm = async function (req, res, next) {
  ...
  // webHelper.sessionRedirect(next, res, req, "/mandatory/check-your-answers/check-your-answers");
  webHelper.sessionRedirect(next, res, req, "/mandatory/question6/question6-3");
};
...
exports.question6Page3 = async function (req, res, next) {
  ...
  res.render("mandatory/question6-3", { data: req.session.data });
};
...
exports.question6Page3Post = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("mandatory/question6-3", {
      data: req.session.data,
  ...
  if (req.body["q6iiiNonUKGovt"] === "Yes") {
    ...
    if (
      ...
      webHelper.sessionRedirect(
        ...
        res,
        req,
        "/mandatory/question6/question6-4a"
      );
    } else {
      webHelper.sessionRedirect(
        next,
        res,
        req,
        "/mandatory/question6/question6-4"
      );
    }
...
exports.question6Page4 = async function (req, res, next) {
  ...
  res.render("mandatory/question6-4", { data: req.session.data });
};
...
exports.question6Page4Post = async function (req, res, next) {
  var validationOutput = validator.validateQuestion6Page4(req.session.data);
  if (validationOutput.isValid === false) {
    res.render("mandatory/question6-4", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
...
exports.question6Page4a = async function (req, res, next) {
  ...
  res.render("mandatory/question6-4a", { data: req.session.data });
};
...
exports.question6Page4aPost = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("mandatory/question6-4a", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
...
exports.question6Page4Edit = async function (req, res, next) {
  ...
  res.render("mandatory/question6-4a", { data: editItem, editingItem: true });
};
...
exports.getQuestion6Page4Remove = async function (req, res, next) {
  ...
  res.render("mandatory/question6-4confirm", {
...
exports.question6Page1rem = async function (req, res, next) {
  ...
  res.render("mandatory/question6-1conf", {
...
exports.question6Page1RemConfPost = async function (req, res, next) {
  ...
  webHelper.sessionRedirect(next, res, req, "/mandatory/question6/question6-1");
};
...
exports.question6Page2rem = async function (req, res, next) {
  ...
  res.render("mandatory/question6-2conf", {
    uploadedFileId: req.params.id,
    uploadedFileName: recordRef,
  });
};
