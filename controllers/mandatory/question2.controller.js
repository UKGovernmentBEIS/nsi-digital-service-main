...
exports.getQuestion2Page1 = async function (req, res, next) {
  ...
  if (
    ...
    res.render("mandatory/question2-1", { data: req.session.data });
  } else {
    webHelper.sessionRedirect(
      next,
      res,
      req,
      "/mandatory/question2/question2-2"
    );
  }
};
...
exports.getQuestion2Page1Post = async function (req, res, next) {
  ...
  if (req.session.data["q2iSubmitTwelve"] === "Yes") {
    webHelper.sessionRedirect(
      ...
      res,
      req,
      "/mandatory/question2/question2-2a"
    );
  } else {
    /* The field is populated with "Dontknow" to avoid the app from crashing */
    /* TODO - remove field from database */
    req.session.data["q2iiSubmitTwelve"] = "Dontknow";
...
exports.getQuestion2Page2 = async function (req, res, next) {
  ...
  res.render("mandatory/question2-2", { data: req.session.data });
};
...
exports.getQuestion2Page2a = async function (req, res, next) {
  ...
  res.render("mandatory/question2-2a", { data: req.session.data });
};
...
exports.getQuestion2Page2aPost = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("mandatory/question2-2a", {
  ...
  webHelper.sessionRedirect(next, res, req, "/mandatory/question2/question2-2");
};
...
exports.getQuestion2Page2cya = async function (req, res, next) {
  ...
  res.render("mandatory/question2-2a", { data: newPostData, isEditing: true });
};
...
exports.getQuestion2Page2rem = async function (req, res, next) {
  ...
  res.render("mandatory/question2-2conf", {
...
exports.getQuestion2Page2remConfPost = async function (req, res, next) {
  ...
  webHelper.sessionRedirect(next, res, req, "/mandatory/question2/question2-1");
};
