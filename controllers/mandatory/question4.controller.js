...
exports.getQuestion4Page1 = async function (req, res, next) {
  ...
  res.render("mandatory/question4-1", { data: req.session.data });
};
...
exports.getQuestion4Page1Post = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("mandatory/question4-1", {
  ...
  if (
    ...
    webHelper.sessionRedirect(
      ...
      res,
      req,
      "/mandatory/question4/question4-02"
    );
  } else {
    webHelper.sessionRedirect(
      next,
      res,
      req,
      "/mandatory/question4/question4-2"
    );
  }
};
...
exports.getQuestion4Page02 = async function (req, res, next) {
  ...
  if (
    ...
    res.render("mandatory/question4-02", { data: req.session.data });
  } else {
    webHelper.sessionRedirect(
      next,
      res,
...
exports.getQuestion4Page02Post = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("mandatory/question4-02", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
  ...
  if (req.session.data["q4iiRegulatoryApproval"] === "Yes") {
    webHelper.sessionRedirect(
      ...
      res,
      req,
      "/mandatory/question4/question4-2a"
    );
  } else {
    if (
      ...
      webHelper.sessionRedirect(
        ...
        res,
        req,
        "/mandatory/question4/question4-03"
      );
    } else {
      webHelper.sessionRedirect(
        next,
        res,
        req,
        "/mandatory/question4/question4-3"
      );
    }
  }
};
...
exports.getQuestion4Page2 = async function (req, res, next) {
  ...
  res.render("mandatory/question4-2", { data: req.session.data });
};
...
exports.getQuestion4Page2a = async function (req, res, next) {
  ...
  res.render("mandatory/question4-2a", { data: req.session.data });
};
...
exports.getQuestion4Page2aPost = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("mandatory/question4-2a", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
  ...
  webHelper.sessionRedirect(next, res, req, "/mandatory/question4/question4-2");
};
...
exports.getQuestion4Page2cya = async function (req, res, next) {
  ...
  res.render("mandatory/question4-2a", { data: newPostData, isEditing: true });
};
...
exports.getQuestion4Page2rem = async function (req, res, next) {
  ...
  res.render("mandatory/question4-2conf", {
...
exports.getQuestion4Page03 = async function (req, res, next) {
  ...
  if (
    ...
    res.render("mandatory/question4-03", { data: req.session.data });
  } else {
    webHelper.sessionRedirect(
      next,
      res,
...
exports.getQuestion4Page03Post = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("mandatory/question4-03", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
  ...
  if (req.session.data["q4iiiOtherKeyDates"] === "Yes") {
    webHelper.sessionRedirect(
      ...
      res,
      req,
      "/mandatory/question4/question4-3a"
    );
  } else {
...
exports.getQuestion4Page3 = async function (req, res, next) {
  ...
  res.render("mandatory/question4-3", { data: req.session.data });
};
...
exports.getQuestion4Page3a = async function (req, res, next) {
  ...
  res.render("mandatory/question4-3a", { data: req.session.data });
};
...
exports.getQuestion4Page3aPost = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("mandatory/question4-3a", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
  ...
  // create a readable date string
  var newDateString =
    req.session.data["q4icKeyDate-day"] +
    "/" +
    req.session.data["q4icKeyDate-month"] +
    "/" +
    req.session.data["q4icKeyDate-year"];
  ...
  webHelper.sessionRedirect(next, res, req, "/mandatory/question4/question4-3");
};
...
exports.getQuestion4Page3cya = async function (req, res, next) {
  ...
  for (var i = 0; i < req.session.data["q4icKeyDatesList"].length; i++) {
    if (req.session.data["q4icKeyDatesList"][i].id === req.params.id) {
      ...
      newPostData["question4icShortDescription"] =
        req.session.data["q4icKeyDatesList"][i].question4icShortDescription;
      newPostData["q4icKeyDate-day"] = dateParts[0];
      newPostData["q4icKeyDate-month"] = dateParts[1];
      newPostData["q4icKeyDateY-year"] = dateParts[2];
  ...
  res.render("mandatory/question4-3a", { data: newPostData, isEditing: true });
};
...
exports.getQuestion4Page3rem = async function (req, res, next) {
  ...
  res.render("mandatory/question4-3conf", {
