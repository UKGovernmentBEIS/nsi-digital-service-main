...
exports.getQuestion7Page1 = async function (req, res, next) {
  ...
  res.render("voluntary/question7-1", { data: req.session.data });
};
...
exports.getQuestion7Page1Post = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("voluntary/question7-1", {
  ...
  if (req.body["q7iEntityOrIndividual"] === "entity") {
    webHelper.sessionRedirect(
      ...
      res,
      req,
      "/voluntary/question7/question7-2"
    );
    ...
    webHelper.sessionRedirect(
      ...
      res,
      req,
      "/voluntary/question7/question7-3"
    );
  } else {
    // Go to the main page
    webHelper.sessionRedirect(
      ...
      res,
      req,
      "/voluntary/question7/question7-1"
    );
  }
};
...
exports.getQuestion7Page2 = async function (req, res, next) {
  ...
  res.render("voluntary/question7-2", { data: req.session.data });
};

/* Handles the post for question 7 page 2 */
exports.getQuestion7Page2Post = async function (req, res, next) {
  //log.Debug("Starting get notification activities", "notifications.controller", "GET:getNotificationsList");
  webHelper.sessionRedirect(next, res, req, "/voluntary/question7/question7-3");
};
...
exports.getQuestion7Page3 = async function (req, res, next) {
  ...
  res.render("voluntary/question7-3", { data: req.session.data });
};
...
exports.getQuestion7Page3Post = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("voluntary/question7-3", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
  ...
  if (
    ...
    webHelper.sessionRedirect(
      ...
      res,
      req,
      "/voluntary/question7/question7-04"
    );
  } else {
    webHelper.sessionRedirect(
      next,
      res,
      req,
      "/voluntary/question7/question7-4"
    );
  }
};
...
exports.question7Page04 = async function (req, res, next) {
  ...
  res.render("voluntary/question7-04", { data: req.session.data });
};
...
exports.question7Page04Post = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("voluntary/question7-04", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
  ...
  if (req.body["q7iiNonUKGovt"] === "Yes") {
    ...
    webHelper.sessionRedirect(
      ...
      res,
      req,
      "/voluntary/question7/question7-4a"
    );
    ...
    webHelper.sessionRedirect(
      ...
      res,
      req,
      "/voluntary/question7/question7-5"
    );
  }
};
...
exports.getQuestion7Page4 = async function (req, res, next) {
  ...
  if (
    ...
    res.render("voluntary/question7-4", { data: req.session.data });
  }
};
...
exports.getQuestion7Page4a = async function (req, res, next) {
  ...
  res.render("voluntary/question7-4a", { data: req.session.data });
};
...
exports.getQuestion7Page4aPost = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("voluntary/question7-4a", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
  ...
  webHelper.sessionRedirect(next, res, req, "/voluntary/question7/question7-4");
};
...
exports.getQuestion7Page4cya = async function (req, res, next) {
  ...
  res.render("voluntary/question7-4a", { data: newPostData, isEditing: true });
};
...
exports.getQuestion7Page4rem = async function (req, res, next) {
  ...
  res.render("voluntary/question7-4conf", {
...
exports.question7Page05 = async function (req, res, next) {
  ...
  res.render("voluntary/question7-05", { data: req.session.data });
};
...
exports.question7Page05Post = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("voluntary/question7-05", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
  ...
  if (req.body["q7iiiNonUKGovt"] === "Yes") {
    ...
    webHelper.sessionRedirect(
      ...
      res,
      req,
      "/voluntary/question7/question7-5a"
    );
    ...
    webHelper.sessionRedirect(
      ...
      res,
      req,
      "/voluntary/question7/question7-6"
    );
  } else {
    ...
    webHelper.sessionRedirect(
      ...
      res,
      req,
      "/voluntary/question7/question7-05"
    );
  }
};
...
exports.getQuestion7Page5 = async function (req, res, next) {
  ...
  if (
    ...
    res.render("voluntary/question7-5", { data: req.session.data });
  }
};
...
exports.getQuestion7Page5a = async function (req, res, next) {
  ...
  res.render("voluntary/question7-5a", { data: req.session.data });
};
...
exports.getQuestion7Page5aPost = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("voluntary/question7-5a", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
  ...
  webHelper.sessionRedirect(next, res, req, "/voluntary/question7/question7-5");
};
...
exports.getQuestion7Page5cya = async function (req, res, next) {
  ...
  res.render("voluntary/question7-5a", { data: newPostData, isEditing: true });
};
...
exports.getQuestion7Page5rem = async function (req, res, next) {
  ...
  res.render("voluntary/question7-5conf", {
    nonGovernmentEntityId: req.params.id,
    nonGovernmentEntityRef: recordRef,
  });
};
...
exports.getQuestion7Page6 = async function (req, res, next) {
  ...
  res.render("voluntary/question7-6", { data: req.session.data });
};
...
exports.getQuestion7Page6Post = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("voluntary/question7-6", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
