...
exports.question1Page0 = async function (req, res, next) {
  console.log(req.session.data);

  res.render("voluntary/question1-0", { data: req.session.data });
};

exports.question1Page0Post = async function (req, res, next) {
  // perform the field validation
  var validationOutput = validator.validateQuestion1Page0(req.session.data);
  if (validationOutput.isValid === false) {
    res.render("voluntary/question1-0", {
  ...
  webHelper.sessionRedirect(next, res, req, "/voluntary/question1/question1-1");
};
...
exports.question1Page1 = async function (req, res, next) {
  ...
  res.render("voluntary/question1-1", { data: req.session.data });
};

exports.question1Page1Post = async function (req, res, next) {
  const { q1iNotifyingPartyOrRepresentative } = req.session.data;

  // perform the field validation
  var validationOutput = validator.validateQuestion1Page1(req.session.data);
  if (validationOutput.isValid === false) {
    res.render("voluntary/question1-1", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
  ...
  webHelper.sessionRedirect(
    ...
    q1iNotifyingPartyOrRepresentative === "notifyingParty"
      ? "/voluntary/question1/question1-2"
      : "/voluntary/question1/question1-3"
  );
};

exports.question1Page2 = async function (req, res, next) {
  res.render("voluntary/question1-2", { data: req.session.data });
};
...
exports.question1Page2Post = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("voluntary/question1-2", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
  ...
  // Populate the session with the authorised contact in case of notifyingParty
  if (req.session.data.q1iiAuthorised === "Yes") {
    req.session.data["authorisedContactEmail"] =
      req.session.data.q1iiNotifyingPartyEmail;
    req.session.data["authorisedContactName"] =
      req.session.data.q1iiNotifyingPartyIndividual;
  } else {
    req.session.data["authorisedContactEmail"] =
  ...
  const { q10WhichType } = req.session.data;

  if (q10WhichType === "Acquirer") {
    if (
      ...
      webHelper.sessionRedirect(
        ...
        res,
        req,
        "/voluntary/question1/question1-4"
      );
    } else {
      webHelper.sessionRedirect(
        next,
        res,
        req,
        "/voluntary/question1/question1-4b"
      );
    }
  } else {
...
exports.question1Page3 = async function (req, res, next) {
  res.render("voluntary/question1-3", { data: req.session.data });
};
...
exports.question1Page3Post = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("voluntary/question1-3", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
...
exports.question1Page4 = async function (req, res, next) {
  ...
  if (q10WhichType === "Acquirer") {
    if (
      ...
      res.render("voluntary/question1-4");
    } else {
      webHelper.sessionRedirect(
        next,
        res,
...
exports.question1Page4Post = async function (req, res, next) {
  ...
  if (q1ivAdditionalAcquirer === "Yes") {
    webHelper.sessionRedirect(
      ...
      res,
      req,
      "/voluntary/question1/question1-4a"
    );
  } else {
    webHelper.sessionRedirect(next, res, req, "/voluntary/task-list");
  }
...
exports.question1Page4a = async function (req, res, next) {
  res.render("voluntary/question1-4a");
};
...
exports.question1Page4b = async function (req, res, next) {
  console.log(req.session.data);
  res.render("voluntary/question1-4b", { data: req.session.data });
};
...
exports.question1Page4bRem = async function (req, res, next) {
  ...
  res.render("voluntary/question1-4conf", {
...
exports.question1Page4ConfPost = async function (req, res, next) {
  ...
  webHelper.sessionRedirect(next, res, req, "/voluntary/question1/question1-4");
};
...
exports.question1Page4bcya = async function (req, res, next) {
  ...
  res.render("voluntary/question1-4a", { data, isEditing: true });
};
