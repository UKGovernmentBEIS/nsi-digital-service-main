...
exports.getQuestion4Page1 = async function (req, res, next) {
  ...
  res.render("voluntary/question4-1", { data: req.session.data });
};
...
exports.getQuestion4Page1Post = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("voluntary/question4-1", {
  ...
  if (
    ...
    webHelper.sessionRedirect(
      ...
      res,
      req,
      "/voluntary/question4/question4-02"
    );
  } else {
    webHelper.sessionRedirect(
      next,
      res,
      req,
      "/voluntary/question4/question4-2"
    );
  }
};
...
exports.getQuestion4Page02 = async function (req, res, next) {
  ...
  if (
    ...
    res.render("voluntary/question4-02", { data: req.session.data });
  } else {
    webHelper.sessionRedirect(
      next,
      res,
...
exports.getQuestion4Page02Post = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("voluntary/question4-02", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
  ...
  if (req.session.data["q4iiRegulatoryApproval"] === "Yes") {
    webHelper.sessionRedirect(
      ...
      res,
      req,
      "/voluntary/question4/question4-2a"
    );
  } else {
    webHelper.sessionRedirect(
      next,
      res,
      req,
      "/voluntary/question4/question4-03"
    );
  }
};
...
exports.getQuestion4Page2 = async function (req, res, next) {
  ...
  if (
    ...
    res.render("voluntary/question4-2", { data: req.session.data });
  }
};
...
exports.getQuestion4Page2a = async function (req, res, next) {
  ...
  res.render("voluntary/question4-2a", { data: req.session.data });
};
...
exports.getQuestion4Page2aPost = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("voluntary/question4-2a", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
  ...
  webHelper.sessionRedirect(next, res, req, "/voluntary/question4/question4-2");
};
...
exports.getQuestion4Page2cya = async function (req, res, next) {
  ...
  res.render("voluntary/question4-2a", { data: newPostData, isEditing: true });
};
...
exports.getQuestion4Page2rem = async function (req, res, next) {
  ...
  res.render("voluntary/question4-2conf", {
...
exports.getQuestion4Page03 = async function (req, res, next) {
  ...
  if (
    ...
    res.render("voluntary/question4-03", { data: req.session.data });
  } else {
    webHelper.sessionRedirect(
      next,
      res,
      req,
      "/voluntary/question4/question4-3"
    );
  }
};
...
exports.getQuestion4Page03Post = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("voluntary/question4-03", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
  ...
  if (req.session.data["q4iiiOtherKeyDates"] === "Yes") {
    webHelper.sessionRedirect(
      ...
      res,
      req,
      "/voluntary/question4/question4-3a"
    );
  } else {
...
exports.getQuestion4Page3 = async function (req, res, next) {
  ...
  if (
    ...
    res.render("voluntary/question4-3", { data: req.session.data });
  }
};
...
exports.getQuestion4Page3a = async function (req, res, next) {
  ...
  res.render("voluntary/question4-3a", { data: req.session.data });
};
...
exports.getQuestion4Page3aPost = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("voluntary/question4-3a", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
  ...
  webHelper.sessionRedirect(next, res, req, "/voluntary/question4/question4-3");
};
...
exports.getQuestion4Page3cya = async function (req, res, next) {
  ...
  res.render("voluntary/question4-3a", { data: newPostData, isEditing: true });
};
...
exports.getQuestion4Page3rem = async function (req, res, next) {
  ...
  res.render("voluntary/question4-3conf", {
