...
exports.question9Page1 = async function (req, res, next) {
  if (
    ...
    res.render("voluntary/question9-1", { data: req.session.data });
  } else {
    res.render("voluntary/question9-1", {
...
exports.question9Page1Post = async function (req, res, next) {
  ...
  var uploadValidation =
    fileUploadValidator.voluntaryValidateFileUploadQuestion9Page1(req);
  if (uploadValidation.isValid === false) {
    ...
    webHelper.sessionRedirect(
      ...
      res,
      req,
      "/voluntary/question9/question9-1"
    );
    return;
  }
...
exports.question9Page1PostConfirm = async function (req, res, next) {
  ...
  req.session.data["q9iAdditionalDocumentationFileNames"] = "";
...
exports.question9Page1rem = async function (req, res, next) {
  ...
  res.render("voluntary/question9-1conf", {
...
exports.question9Page1RemConfPost = async function (req, res, next) {
  ...
  webHelper.sessionRedirect(next, res, req, "/voluntary/question9/question9-1");
};
