...
exports.question8Page1 = async function (req, res, next) {
  if (
    ...
    res.render("voluntary/question8-1", { data: req.session.data });
  } else {
    res.render("voluntary/question8-1", {
...
exports.question8Page1Post = async function (req, res, next) {
  ...
  var uploadValidation =
    fileUploadValidator.voluntaryValidateFileUploadQuestion8Page1(req);
  if (uploadValidation.isValid === false) {
    ...
    webHelper.sessionRedirect(
      ...
      res,
      req,
      "/voluntary/question8/question8-1"
    );
    return;
  }
  ...
  if (dataUpload == "success") {
    ...
    if (
      ...
      webHelper.sessionRedirect(
        ...
        res,
        req,
        "/voluntary/question8/question8-2a"
      );
    } else {
      webHelper.sessionRedirect(
        next,
        res,
        req,
        "/voluntary/question8/question8-2"
      );
    }
  } else {
    return next({
...
exports.getQuestion8Page2 = async function (req, res, next) {
  ...
  if (
    ...
    res.render("voluntary/question8-2", { data: req.session.data });
  }
};
...
exports.getQuestion8Page2a = async function (req, res, next) {
  ...
  res.render("voluntary/question8-2a", { data: req.session.data });
};
...
exports.getQuestion8Page2aPost = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("voluntary/question8-2a", {
      data: req.session.data,
  ...
  webHelper.sessionRedirect(next, res, req, "/voluntary/question8/question8-2");
};
...
exports.getQuestion8Page2cya = async function (req, res, next) {
  ...
  res.render("voluntary/question8-2a", { data: newPostData, isEditing: true });
};
...
exports.getQuestion8Page2rem = async function (req, res, next) {
  ...
  res.render("voluntary/question8-2conf", {
...
exports.question8Page1rem = async function (req, res, next) {
  ...
  res.render("voluntary/question8-1conf", {
...
exports.question8Page1RemConfPost = async function (req, res, next) {
  ...
  webHelper.sessionRedirect(next, res, req, "/voluntary/question8/question8-1");
};
