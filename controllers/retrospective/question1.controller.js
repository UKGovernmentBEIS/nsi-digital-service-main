...
exports.question1Page0 = async function (req, res, next) {
  ...
  res.render("retrospective/question1-0", { data: req.session.data });
};
...
exports.question1Page0Post = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("retrospective/question1-0", {
  ...
  webHelper.sessionRedirect(
    ...
    res,
    req,
    "/retrospective/question1/question1-1"
  );
};
...
exports.question1Page1 = async function (req, res, next) {
  ...
  res.render("retrospective/question1-1", { data: req.session.data });
};
...
exports.question1Page1Post = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("retrospective/question1-1", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
  ...
  webHelper.sessionRedirect(
    ...
    q1iNotifyingPartyOrRepresentative === "notifyingParty"
      ? "/retrospective/question1/question1-2"
      : "/retrospective/question1/question1-3"
  );
};

exports.question1Page2 = async function (req, res, next) {
  res.render("retrospective/question1-2", { data: req.session.data });
};
...
exports.question1Page2Post = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("retrospective/question1-2", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
  ...
  if (q10WhichType === "Acquirer") {
    if (
      ...
      webHelper.sessionRedirect(
        ...
        res,
        req,
        "/retrospective/question1/question1-4"
      );
    } else {
      webHelper.sessionRedirect(
        next,
        res,
        req,
        "/retrospective/question1/question1-4b"
      );
    }
  } else {
...
exports.question1Page3 = async function (req, res, next) {
  res.render("retrospective/question1-3", { data: req.session.data });
};
...
exports.question1Page3Post = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("retrospective/question1-3", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
...
exports.question1Page4 = async function (req, res, next) {
  ...
  if (q10WhichType === "Acquirer") {
    ...
    if (
      ...
      res.render("retrospective/question1-4");
    } else {
      webHelper.sessionRedirect(
        next,
        res,
...
exports.question1Page4Post = async function (req, res, next) {
  ...
  if (q1ivAdditionalAcquirer === "Yes") {
    webHelper.sessionRedirect(
      ...
      res,
      req,
      "/retrospective/question1/question1-4a"
    );
  } else {
    webHelper.sessionRedirect(next, res, req, "/retrospective/task-list");
  }
...
exports.question1Page4a = async function (req, res, next) {
  res.render("retrospective/question1-4a");
};
...
exports.question1Page4b = async function (req, res, next) {
  console.log(req.session.data);
  res.render("retrospective/question1-4b", { data: req.session.data });
};
...
exports.question1Page4bRem = async function (req, res, next) {
  ...
  res.render("retrospective/question1-4conf", {
...
exports.question1Page4bcya = async function (req, res, next) {
  ...
  res.render("retrospective/question1-4a", { data, isEditing: true });
};
