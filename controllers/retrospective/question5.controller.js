...
exports.question5Page1 = async function (req, res, next) {
  res.render("retrospective/question5-1", { data: req.session.data });
};
...
exports.question5Page1Post = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("retrospective/question5-1", {
  ...
  webHelper.sessionRedirect(
    ...
    res,
    req,
    "/retrospective/question5/question5-2"
  );
};
...
exports.question5Page2 = async function (req, res, next) {
  if (
    ...
    res.render("retrospective/question5-2", { data: req.session.data });
  } else {
    webHelper.sessionRedirect(
      next,
      res,
      req,
      "/retrospective/question5/question5-2b"
    );
  }
};
...
exports.question5Page2Post = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("retrospective/question5-2", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
  ...
  if (q5iiIsAuthorised === "Yes") {
    if (
      ...
      webHelper.sessionRedirect(
        ...
        res,
        req,
        "/retrospective/question5/question5-2a"
      );
    } else {
      webHelper.sessionRedirect(
        next,
    ...
    webHelper.sessionRedirect(
      ...
      res,
      req,
      "/retrospective/question5/question5-3"
    );
  }
};

exports.question5Page2A = async function (req, res, next) {
  res.render("retrospective/question5-2a", { data: req.session.data });
};
...
exports.question5Page2APost = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("retrospective/question5-2a", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
...
exports.question5Page2B = async function (req, res, next) {
  if (
    ...
    res.render("retrospective/question5-2b", { data: req.session.data });
  }
};
...
exports.question5Page2BRem = async function (req, res, next) {
  ...
  res.render("retrospective/question5-2conf", {
...
exports.question5Page2Bcya = async function (req, res, next) {
  ...
  res.render("retrospective/question5-2a", { data, isEditing: true });
};
...
exports.question5Page3 = async function (req, res, next) {
  if (
    ...
    res.render("retrospective/question5-3", { data: req.session.data });
  } else {
    webHelper.sessionRedirect(
      next,
      res,
      req,
      "/retrospective/question5/question5-3b"
    );
  }
};
...
exports.question5Page3Post = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("retrospective/question5-3", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
  ...
  if (q5iiiIsLicenseRequired === "Yes") {
    if (
      ...
      webHelper.sessionRedirect(
        ...
        res,
        req,
        "/retrospective/question5/question5-3a"
      );
    } else {
      webHelper.sessionRedirect(
        next,
    ...
    webHelper.sessionRedirect(
      ...
      res,
      req,
      "/retrospective/question5/question5-4"
    );
  }
};

exports.question5Page3A = async function (req, res, next) {
  res.render("retrospective/question5-3a", { data: req.session.data });
};
...
exports.question5Page3APost = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("retrospective/question5-3a", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
...
exports.question5Page3B = async function (req, res, next) {
  res.render("retrospective/question5-3b", { data: req.session.data });
};
...
exports.question5Page3BRem = async function (req, res, next) {
  ...
  res.render("retrospective/question5-3conf", {
    removeItemId: req.params.id,
    itemRef,
  });
};
...
exports.question5Page3Bcya = async function (req, res, next) {
  ...
  res.render("retrospective/question5-3a", { data, isEditing: true });
};
...
exports.question5Page4 = async function (req, res, next) {
  if (
    ...
    res.render("retrospective/question5-4", { data: req.session.data });
  } else {
    webHelper.sessionRedirect(
      next,
      res,
      req,
      "/retrospective/question5/question5-4b"
    );
  }
};
...
exports.question5Page4Post = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("retrospective/question5-4", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
  ...
  if (q5ivIsDualUse === "Yes") {
    if (
      ...
      webHelper.sessionRedirect(
        ...
        res,
        req,
        "/retrospective/question5/question5-4a"
      );
    } else {
      webHelper.sessionRedirect(
        next,
    ...
    webHelper.sessionRedirect(
      ...
      res,
      req,
      "/retrospective/question5/question5-5"
    );
  }
};

exports.question5Page4A = async function (req, res, next) {
  res.render("retrospective/question5-4a", { data: req.session.data });
};
...
exports.question5Page4APost = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("retrospective/question5-4a", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
...
exports.question5Page4B = async function (req, res, next) {
  res.render("retrospective/question5-4b", { data: req.session.data });
};
...
exports.question5Page4BRem = async function (req, res, next) {
  ...
  res.render("retrospective/question5-4conf", {
    removeItemId: req.params.id,
    itemRef,
  });
};
...
exports.question5Page4Bcya = async function (req, res, next) {
  ...
  res.render("retrospective/question5-4a", { data, isEditing: true });
};
...
exports.question5Page5 = async function (req, res, next) {
  if (
    ...
    res.render("retrospective/question5-5", { data: req.session.data });
  } else {
    webHelper.sessionRedirect(
      next,
      res,
      req,
      "/retrospective/question5/question5-5b"
    );
  }
};
...
exports.question5Page5Post = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("retrospective/question5-5", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
  ...
  if (q5vIsPartyTo === "Yes") {
    if (
      ...
      webHelper.sessionRedirect(
        ...
        res,
        req,
        "/retrospective/question5/question5-5a"
      );
    } else {
      webHelper.sessionRedirect(
        next,
    ...
    webHelper.sessionRedirect(
      ...
      res,
      req,
      "/retrospective/question5/question5-6"
    );
  }
};

exports.question5Page5A = async function (req, res, next) {
  res.render("retrospective/question5-5a", { data: req.session.data });
};
...
exports.question5Page5APost = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("retrospective/question5-5a", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
...
exports.question5Page5B = async function (req, res, next) {
  res.render("retrospective/question5-5b", { data: req.session.data });
};
...
exports.question5Page5BRem = async function (req, res, next) {
  ...
  res.render("retrospective/question5-5conf", {
    removeItemId: req.params.id,
    itemRef,
  });
};
...
exports.question5Page5Bcya = async function (req, res, next) {
  ...
  res.render("retrospective/question5-5a", { data, isEditing: true });
};
...
exports.question5Page6 = async function (req, res, next) {
  if (
    ...
    res.render("retrospective/question5-6", { data: req.session.data });
  } else {
    webHelper.sessionRedirect(
      next,
      res,
      req,
      "/retrospective/question5/question5-6b"
    );
  }
};
...
exports.question5Page6Post = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("retrospective/question5-6", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
  ...
  if (q5viIsFundedResearch === "Yes") {
    if (
      ...
      webHelper.sessionRedirect(
        ...
        res,
        req,
        "/retrospective/question5/question5-6a"
      );
    } else {
      webHelper.sessionRedirect(
        next,
    ...
    webHelper.sessionRedirect(
      ...
      res,
      req,
      "/retrospective/question5/question5-7"
    );
  }
};

exports.question5Page6A = async function (req, res, next) {
  res.render("retrospective/question5-6a", { data: req.session.data });
};
...
exports.question5Page6APost = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("retrospective/question5-6a", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
...
exports.question5Page6B = async function (req, res, next) {
  res.render("retrospective/question5-6b", { data: req.session.data });
};
...
exports.question5Page6BRem = async function (req, res, next) {
  ...
  res.render("retrospective/question5-6conf", {
    removeItemId: req.params.id,
    itemRef,
  });
};
...
exports.question5Page6Bcya = async function (req, res, next) {
  ...
  res.render("retrospective/question5-6a", { data, isEditing: true });
};
...
exports.question5Page7 = async function (req, res, next) {
  if (
    ...
    res.render("retrospective/question5-7", { data: req.session.data });
  } else {
    webHelper.sessionRedirect(
      next,
      res,
      req,
      "/retrospective/question5/question5-7b"
    );
  }
};
...
exports.question5Page7Post = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("retrospective/question5-7", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
  ...
  webHelper.sessionRedirect(
    ...
    req,
    q5viiIsNSVSC === "Yes"
      ? "/retrospective/question5/question5-7a"
      : "/retrospective/task-list"
  );
};

exports.question5Page7A = async function (req, res, next) {
  res.render("retrospective/question5-7a", { data: req.session.data });
};
...
exports.question5Page7APost = async function (req, res, next) {
  ...
  if (validationOutput.isValid === false) {
    res.render("retrospective/question5-7a", {
      data: req.session.data,
      formValidation: validationOutput,
    });
    return;
...
exports.question5Page7B = async function (req, res, next) {
  res.render("retrospective/question5-7b", { data: req.session.data });
};
...
exports.question5Page7BRem = async function (req, res, next) {
  ...
  res.render("retrospective/question5-7conf", {
    removeItemId: req.params.id,
    itemRef,
  });
};
...
exports.question5Page7Bcya = async function (req, res, next) {
  ...
  res.render("retrospective/question5-7a", { data, isEditing: true });
};
